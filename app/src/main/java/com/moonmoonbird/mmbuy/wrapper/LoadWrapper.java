package com.moonmoonbird.mmbuy.wrapper;
...
public class LoadWrapper extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LoadWrapper(RecyclerView.Adapter adapter) {
    ...
    public void onAttachedToRecyclerView(RecyclerView recyclerView) {
        ...
        if (manager instanceof StaggeredGridLayoutManager) {
            final StaggeredGridLayoutManager gridManager = ((StaggeredGridLayoutManager) manager);
